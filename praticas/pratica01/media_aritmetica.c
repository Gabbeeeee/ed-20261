...
int main() {
    ...
    float array3[7] = {1.3, 22, 4.5, 13, 7.2, 8, 10}; //entradas decimais
    media = media_aritmetica(array3, 7);
    printf("Media de {1.3, 22, 4.5, 13, 7.2, 8, 10} = %.1f\n", media);

    float array4[4] = {0,0,0,0}; // media de zeros
    media = media_aritmetica(array4, 4);
